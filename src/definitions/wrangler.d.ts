/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/definitions/wrangler.d.ts` (hash: 04d1beb282442e0b2f3c2d04525ea1a1)
// Runtime types generated with workerd@1.20260811.1 2025-11-18 disable_ctx_exports,disable_nodejs_http_server_modules,nodejs_als,nodejs_compat,nodejs_compat_do_not_populate_process_env
interface __BaseEnv_Env {
	...
	QUEUE_SETTINGS: {"enabled":true,"repostsEnabled":true,"postNowEnabled":false,"threadEnabled":true,"pressure_retries":true,"delay_val":100,"max_retries":3,"post_queues":["POST_QUEUE","POST_QUEUE2"],"repost_queues":["REPOST_QUEUE"]};
