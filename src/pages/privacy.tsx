    ...
    <BaseLayout title="Privacy Policy" mainClass="homepage">
      ...
      <section class="container">
        <article>
          ...
          <p>
            Usage of this website ({APP_NAME}) requires collection of data that you provide. Usage of this website is considered an agreement to this policy.
          </p>
          ...
          <p>Here are the privacy policies for the services that {APP_NAME} uses, these links are not kept up to date and may change due to the nature of being from third parties.</p>
          <ul>
