...
export default function MetaTags() {
  return (
    <>
      ...
      <meta name="description" content="Schedule and automatically repost your content automatically on Bluesky! Boost engagement and reach more people no matter what time of day!" />
