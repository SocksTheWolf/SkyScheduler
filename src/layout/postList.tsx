...
export function ScheduledPost(content: Post) {
  ...
  <article>
    <div>
      ${content.posted ? '' : raw(`<button type="submit" hx-post="/post/${content.postid}/delete" hx-target="#posts" hx-swap="innerHTML" hx-trigger="click" class="btn-sm btn-error outline btn-delete">
