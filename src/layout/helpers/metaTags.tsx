...
import {
  APP_NAME, PROJECT_AUTHOR, PROJECT_AUTHOR_SITE,
  SITE_DESCRIPTION, SITE_URL, SOCIAL_CARD_IMAGE
} from "../../appInfo";
...
export function PersonaTags() {
  ...
  return <script type="application/ld+json">{raw(JSON.stringify(personaInfo))}</script>;
}
