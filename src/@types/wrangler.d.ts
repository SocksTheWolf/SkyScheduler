/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/@types/wrangler.d.ts` (hash: f4613fd0122c93a76008108e4ab5fa7e)
// Runtime types generated with workerd@1.20260903.1 2025-11-18 disable_ctx_exports,disable_nodejs_http_server_modules,nodejs_compat,nodejs_compat_do_not_populate_process_env
interface __BaseEnv_Env {
	...
	QUEUE_SETTINGS: {"enabled":true,"postNowEnabled":false,"delay_val":100,"max_retries":3,"post_queues":["POST_QUEUE","POST_QUEUE2"],"repost_queues":["REPOST_QUEUE"]};
	R2_SETTINGS: {"auto_prune":true,"prune_days":3};
	TASK_SETTINGS: {"use_posts":true,"use_reposts":true};
	IN_DEV: false;
	MAINTAIN_LOCKDOWN: false;
