/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/wrangler.d.ts` (hash: a25bbc9209cdfdbc4cf8f49898227f6f)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		QUEUE_SETTINGS: {"enabled":true,"post_queues":["POST_QUEUE1","POST_QUEUE2"],"repost_queues":["REPOST_QUEUE"]};
