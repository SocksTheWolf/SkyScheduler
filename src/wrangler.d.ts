/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/wrangler.d.ts` (hash: 30580cacdcdb02d1ba812614da59e7a5)
// Runtime types generated with workerd@1.20260708.1 2025-11-18 disable_ctx_exports,disable_nodejs_http_server_modules,nodejs_compat,nodejs_compat_do_not_populate_process_env
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	CSP_REPORT_URL: "https://report.skyscheduler.work/csp";
	IMAGE_SETTINGS: {"enabled":true,"steps":[95,85,75],"bucket_url":"https://resize.skyscheduler.work/","max_width":3000};
	QUEUE_SETTINGS: {"enabled":true,"repostsEnabled":true,"postNowEnabled":false,"threadEnabled":true,"pressure_retries":true,"delay_val":100,"max_retries":3,"post_queues":["POST_QUEUE"],"repost_queues":["REPOST_QUEUE"]};
	...
	IN_DEV: string;
	VIDEO_WORKFLOW: Workflow<Parameters<import("./index").UploadVideoAndPublishWorkflow['run']>[0]['payload']>;
}
