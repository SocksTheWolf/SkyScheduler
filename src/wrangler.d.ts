/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/wrangler.d.ts` (hash: bcd41e058513af7c665555c299dadb4e)
// Runtime types generated with workerd@1.20260205.0 2024-12-13 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		SIGNUP_SETTINGS: {"use_captcha":true,"invite_only":false,"invite_thread":"https://bsky.app/profile/skyscheduler.work/post/3ltsfnzdmkk2l"};
		QUEUE_SETTINGS: {"enabled":false,"repostsEnabled":false,"postNowEnabled":false,"threadEnabled":true,"delay_val":100,"post_queues":["POST_QUEUE1"],"repost_queues":[]};
		...
		SITE_SETTINGS: {"use_agent_map":false};
